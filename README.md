...
자연어 질문은 RAG 검색 전에 `detect_intent()`로 먼저 분석합니다. 지원 intent는 `faculty`, `curriculum`, `course_info`, `course_difficulty`, `course_grade_strategy`, `course_order`, `course_roadmap`, `notice`, `schedule`, `general_explain`, `out_of_scope`입니다.
