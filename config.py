...
CRAWL_MAX_SECONDS = max(0, env_int("CRAWL_MAX_SECONDS", 600))
CRAWL_BOARD_PAGE_LIMIT = max(1, env_int("CRAWL_BOARD_PAGE_LIMIT", 5))
...
CRAWL_NOTICE_DETAIL_LIMIT = max(0, env_int("CRAWL_NOTICE_DETAIL_LIMIT", 12))
